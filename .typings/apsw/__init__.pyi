...
from typing import (Any, Callable, Iterable, Iterator, Literal, Optional,
                    Protocol, Sequence, TypeAlias, final)
...
class Connection:
    ...
    *SQLITE_DENY* or *SQLITE_IGNORE*.
    ...
    def trace_v2(self, mask: int, callback: Optional[Callable[[dict[Any,Any]], None]] = None) -> None:
...
class VTCursor(Protocol):
    ...
    def Filter(self, indexnum: int, indexname: str, constraintargs: Optional[tuple[Any,...]]) -> None:
...
class VTTable(Protocol):
    ...
    def FindFunction(self, name: str, nargs: int) -> None |  Callable[[Any],Any] | tuple[int, Callable[[Any],Any]]:
